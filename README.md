...
- **版本**：当前 **v1.0.0**（`py gcal.py --version`；Web 页脚与统计弹窗、离线 H5 页脚同步展示）。版本规则与历史见 [CHANGELOG.md](CHANGELOG.md)（语义化：MAJOR 重构 / MINOR 新功能 / PATCH 修复）
...
- **白天/夜间双主题**：一键切换，localStorage 记忆，首次访问跟随系统偏好
